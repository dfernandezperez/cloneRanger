...
In this document you will find some exploratory plots regarding the distribution of larry barcodes in this single-cell experiment.


# Barcode summary table {.tabset}

Summary metrics of the barcodes across the experiment based on different count thresholds:
...
Representation of the number of barcodes detected per cell based on different thresholds.
...
Here you can find plots regarding the barcode sizes, which corresponds to the number of cells that contain a particular barcode.
